...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bindHandlers = __webpack_require__(32);
	...
	var IdleTimer = function (_Component) {
	  ...
	  function IdleTimer(props) {
	    ...
	    (0, _bindHandlers2.default)(_this);
	    _this.idle = false;
	    return _this;
	  }
...
/***/ function(module, exports) {
	...
	var rxHandler = /^on[A-Z]\w*Handler$/;

	exports.default = function (obj) {
	  var regXp = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : rxHandler;

	  Object.getOwnPropertyNames(Object.getPrototypeOf(obj)).forEach(function (prop) {
